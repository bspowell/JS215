...
function sentiment(text) {
  ...
  let positiveCount = wordList.filter(word => word.match(positiveRegex));
  let negativeCount = wordList.filter(word => word.match(negativeRegex));

  
  console.log(`There are ${positiveCount.length - 1} positive words`)
  console.log(`Positive sentiments are: ${positiveCount.join(', ')}`)

  console.log(`There are ${negativeCount.length - 1} negative words`)
  console.log(`Positive sentiments are: ${negativeCount.join(', ')}`)
